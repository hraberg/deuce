...
* Replaced the EDN based output of the Clojure generated from Emacs Lisp with a [Fipp](https://github.com/brandonbloom/fipp) based [pretty-printer](https://github.com/hraberg/deuce/blob/master/src/deuce/emacs_lisp/printer.clj) that mimics Emacs Lisp a bit to make the generated Clojure code easier to read and look more similar to the Emacs Lisp it comes from.
...
[Engine](https://github.com/e-user/engine) Alexander Kahl, 2011-2012, "Engine new generation internet Emacs." Another Emacs-like editor in Clojure using ACE and web sockets.
