...
Clojure placeholders for some of the Emacs primitives live under `src/emacs`. They are be generated by `./build-stubs` using [`deuce.scaffold`](https://github.com/hraberg/deuce/blob/master/src/deuce/scaffold.clj).
