...
/**
 * Wrapper for library <b>frame</b><br>
...
public class FrameLibrary {
	...
	/// <i>native declaration : frame.h:1600</i>
	/// <i>native declaration : frame.h:1600</i>
	public static abstract class frame_parm_handler extends Callback<frame_parm_handler > {
		public abstract void apply(Pointer<frame > framePtr1, FrameLibrary.Lisp_Object Lisp_Object1);
	};
	/**
	 ...
	 */
	public static native void bidi_paragraph_init(IntValuedEnum<FrameLibrary.bidi_dir_t > bidi_dir_t1, Pointer<bidi_it > bidi_itPtr1, int int1);
	/**
	 ...
	 */
	public static native Pointer<glyph_row > row_containing_pos(Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, Pointer<glyph_row > glyph_rowPtr2, int int1);
	/**
	 ...
	 */
	public static native int display_prop_intangible_p(FrameLibrary.Lisp_Object Lisp_Object1, FrameLibrary.Lisp_Object Lisp_Object2);
	/**
	 ...
	 */
	public static native int resize_mini_window(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int try_window(Lisp_Object, text_pos, int)</code><br>
	 * <i>native declaration : dispextern.h:1759</i>
	 */
	public static native int try_window(FrameLibrary.Lisp_Object Lisp_Object1, text_pos text_pos1, int int1);
	/**
	 * Original signature : <code>void window_box(window*, int, int*, int*, int*, int*)</code><br>
	 * <i>native declaration : dispextern.h:1761</i>
	 */
	public static native void window_box(Pointer<FrameLibrary.window > windowPtr1, int int1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4);
	/**
	 * Original signature : <code>int window_box_height(window*)</code><br>
	 * <i>native declaration : dispextern.h:1763</i>
	 */
	public static native int window_box_height(Pointer<FrameLibrary.window > windowPtr1);
	/**
	 * Original signature : <code>int window_text_bottom_y(window*)</code><br>
	 * <i>native declaration : dispextern.h:1765</i>
	 */
	public static native int window_text_bottom_y(Pointer<FrameLibrary.window > windowPtr1);
	/**
	 * Original signature : <code>int window_box_width(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1767</i>
	 */
	public static native int window_box_width(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int window_box_left(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1769</i>
	 */
	public static native int window_box_left(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int window_box_left_offset(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1771</i>
	 */
	public static native int window_box_left_offset(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int window_box_right(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1773</i>
	 */
	public static native int window_box_right(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int window_box_right_offset(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1775</i>
	 */
	public static native int window_box_right_offset(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int estimate_mode_line_height(frame*, face_id)</code><br>
	 * <i>native declaration : dispextern.h:1777</i>
	 */
	public static native int estimate_mode_line_height(Pointer<frame > framePtr1, IntValuedEnum<FrameLibrary.face_id > arg1);
	/**
	 ...
	 */
	public static native void mark_window_display_accurate(FrameLibrary.Lisp_Object Lisp_Object1, int int1);
	/**
	 ...
	 */
	public static native void init_iterator(Pointer<it > itPtr1, Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, IntValuedEnum<FrameLibrary.face_id > arg1);
	/**
	 ...
	 */
	public static native void init_iterator_to_row_start(Pointer<it > itPtr1, Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1);
	/**
	 * Original signature : <code>void start_display(it*, window*, text_pos)</code><br>
	 * <i>native declaration : dispextern.h:1791</i>
	 */
	public static native void start_display(Pointer<it > itPtr1, Pointer<FrameLibrary.window > windowPtr1, text_pos text_pos1);
	/**
	 ...
	 */
	public static native void move_it_in_display_line(Pointer<it > it, FrameLibrary.EMACS_INT to_charpos, int to_x, IntValuedEnum<FrameLibrary.move_operation_enum > op);
	/**
	 ...
	 */
	public static native FrameLibrary.Lisp_Object lookup_glyphless_char_display(int int1, Pointer<it > itPtr1);
	/**
	 ...
	 */
	public static native FrameLibrary.EMACS_INT compute_display_string_pos(Pointer<text_pos > text_posPtr1, Pointer<bidi_string_data > bidi_string_dataPtr1, int int1, Pointer<Integer > intPtr1);
	/**
	 ...
	 */
	public static native FrameLibrary.EMACS_INT compute_display_string_end(FrameLibrary.EMACS_INT EMACS_INT1, Pointer<bidi_string_data > bidi_string_dataPtr1);
	/**
	 ...
	 */
	public static native void x_clear_window_mouse_face(Pointer<FrameLibrary.window > windowPtr1);
	/**
	 ...
	 */
	public static native int clear_mouse_face(Pointer<FrameLibrary.Mouse_HLInfo > Mouse_HLInfoPtr1);
	/**
	 * Original signature : <code>int cursor_in_mouse_face_p(window*)</code><br>
	 * <i>native declaration : dispextern.h:1839</i>
	 */
	public static native int cursor_in_mouse_face_p(Pointer<FrameLibrary.window > w);
	/**
	 ...
	 */
	public static native void tty_draw_row_with_mouse_face(Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, int int1, int int2, IntValuedEnum<FrameLibrary.draw_glyphs_face > arg1);
	/**
	 * Original signature : <code>int lookup_fringe_bitmap(Lisp_Object)</code><br>
	 * <i>native declaration : dispextern.h:1843</i>
	 */
	public static native int lookup_fringe_bitmap(FrameLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void draw_fringe_bitmap(window*, glyph_row*, int)</code><br>
	 * <i>native declaration : dispextern.h:1845</i>
	 */
	public static native void draw_fringe_bitmap(Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, int int1);
	/**
	 * Original signature : <code>void draw_row_fringe_bitmaps(window*, glyph_row*)</code><br>
	 * <i>native declaration : dispextern.h:1847</i>
	 */
	public static native void draw_row_fringe_bitmaps(Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1);
	/**
	 * Original signature : <code>int draw_window_fringes(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1849</i>
	 */
	public static native int draw_window_fringes(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int update_window_fringes(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1851</i>
	 */
	public static native int update_window_fringes(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 ...
	 */
	public static native void update_face_from_frame_parameter(Pointer<frame > framePtr1, FrameLibrary.Lisp_Object Lisp_Object1, FrameLibrary.Lisp_Object Lisp_Object2);
	/**
	 * Original signature : <code>Lisp_Object tty_color_name(frame*, int)</code><br>
	 * <i>native declaration : dispextern.h:1871</i>
	 */
	public static native FrameLibrary.Lisp_Object tty_color_name(Pointer<frame > framePtr1, int int1);
	/**
	 ...
	 */
	@CLong 
	public static native long load_color(Pointer<frame > framePtr1, Pointer<face > facePtr1, FrameLibrary.Lisp_Object Lisp_Object1, IntValuedEnum<FrameLibrary.lface_attribute_index > arg1);
	/**
	 ...
	 */
	public static native Pointer<Byte > choose_face_font(Pointer<frame > framePtr1, Pointer<FrameLibrary.Lisp_Object > Lisp_ObjectPtr1, FrameLibrary.Lisp_Object Lisp_Object1, Pointer<Integer > intPtr1);
	/**
	 ...
	 */
	public static native int lookup_named_face(Pointer<frame > framePtr1, FrameLibrary.Lisp_Object Lisp_Object1, int int1);
	/**
	 ...
	 */
	public static native int lookup_derived_face(Pointer<frame > framePtr1, FrameLibrary.Lisp_Object Lisp_Object1, int int1, int int2);
	/**
	 ...
	 */
	public static native int face_at_buffer_position(Pointer<FrameLibrary.window > w, FrameLibrary.EMACS_INT pos, FrameLibrary.EMACS_INT region_beg, FrameLibrary.EMACS_INT region_end, Pointer<FrameLibrary.EMACS_INT > endptr, FrameLibrary.EMACS_INT limit, int mouse, int base_face_id);
	/**
	 ...
	 */
	public static native int face_for_overlay_string(Pointer<FrameLibrary.window > w, FrameLibrary.EMACS_INT pos, FrameLibrary.EMACS_INT region_beg, FrameLibrary.EMACS_INT region_end, Pointer<FrameLibrary.EMACS_INT > endptr, FrameLibrary.EMACS_INT limit, int mouse, FrameLibrary.Lisp_Object overlay);
	/**
	 ...
	 */
	public static native int face_at_string_position(Pointer<FrameLibrary.window > w, FrameLibrary.Lisp_Object string, FrameLibrary.EMACS_INT pos, FrameLibrary.EMACS_INT bufpos, FrameLibrary.EMACS_INT region_beg, FrameLibrary.EMACS_INT region_end, Pointer<FrameLibrary.EMACS_INT > endptr, IntValuedEnum<FrameLibrary.face_id > arg1, int mouse);
	/**
	 * Original signature : <code>int merge_faces(frame*, Lisp_Object, EMACS_INT, int)</code><br>
	 * <i>native declaration : dispextern.h:1907</i>
	 */
	public static native int merge_faces(Pointer<frame > framePtr1, FrameLibrary.Lisp_Object Lisp_Object1, FrameLibrary.EMACS_INT EMACS_INT1, int int1);
	/**
	 * Original signature : <code>int compute_char_face(frame*, int, Lisp_Object)</code><br>
	 * <i>native declaration : dispextern.h:1909</i>
	 */
	public static native int compute_char_face(Pointer<frame > framePtr1, int int1, FrameLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void free_all_realized_faces(Lisp_Object)</code><br>
	 * <i>native declaration : dispextern.h:1911</i>
	 */
	public static native void free_all_realized_faces(FrameLibrary.Lisp_Object Lisp_Object1);
	/**
	 ...
	 */
	public static native FrameLibrary.Lisp_Object buffer_posn_from_coords(Pointer<FrameLibrary.window > windowPtr1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<display_pos > display_posPtr1, Pointer<FrameLibrary.Lisp_Object > Lisp_ObjectPtr1, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, Pointer<Integer > intPtr5, Pointer<Integer > intPtr6);
	/**
	 ...
	 */
	public static native FrameLibrary.Lisp_Object mode_line_string(Pointer<FrameLibrary.window > windowPtr1, IntValuedEnum<FrameLibrary.window_part > arg1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<FrameLibrary.EMACS_INT > EMACS_INTPtr1, Pointer<FrameLibrary.Lisp_Object > Lisp_ObjectPtr1, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, Pointer<Integer > intPtr5, Pointer<Integer > intPtr6);
	/**
	 ...
	 */
	public static native FrameLibrary.Lisp_Object marginal_area_string(Pointer<FrameLibrary.window > windowPtr1, IntValuedEnum<FrameLibrary.window_part > arg1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<FrameLibrary.EMACS_INT > EMACS_INTPtr1, Pointer<FrameLibrary.Lisp_Object > Lisp_ObjectPtr1, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, Pointer<Integer > intPtr5, Pointer<Integer > intPtr6);
	/**
	 ...
	 */
	public static native void free_window_matrices(Pointer<FrameLibrary.window > windowPtr1);
	/**
	 ...
	 */
	public static native void shift_glyph_matrix(Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_matrix > glyph_matrixPtr1, int int1, int int2, int int3);
	/**
	 ...
	 */
	public static native void increment_matrix_positions(Pointer<glyph_matrix > glyph_matrixPtr1, int int1, int int2, FrameLibrary.EMACS_INT EMACS_INT1, FrameLibrary.EMACS_INT EMACS_INT2);
	/**
	 * Original signature : <code>void blank_row(window*, glyph_row*, int)</code><br>
	 * <i>native declaration : dispextern.h:1957</i>
	 */
	public static native void blank_row(Pointer<FrameLibrary.window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, int int1);
	/**
	 ...
	 */
	public static native void set_window_update_flags(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 * Original signature : <code>void update_single_window(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1967</i>
	 */
	public static native void update_single_window(Pointer<FrameLibrary.window > windowPtr1, int int1);
	/**
	 ...
	 */
	public static native void spec_glyph_lookup_face(Pointer<FrameLibrary.window > windowPtr1, Pointer<FrameLibrary.GLYPH > GLYPHPtr1);
	/**
	 ...
	 */
	public static native Pointer<FrameLibrary.terminal > init_initial_terminal();
	/**
	 * Original signature : <code>void tty_turn_off_insert(tty_display_info*)</code><br>
	 * <i>native declaration : dispextern.h:2008</i>
	 */
	public static native void tty_turn_off_insert(Pointer<FrameLibrary.tty_display_info > tty_display_infoPtr1);
	/**
	 ...
	 */
	public static native void produce_special_glyphs(Pointer<it > itPtr1, IntValuedEnum<FrameLibrary.display_element_type > arg1);
	/**
	 ...
	 */
	public static native int tty_capable_p(Pointer<FrameLibrary.tty_display_info > tty_display_infoPtr1, int u1, @CLong long u2, @CLong long u3);
	/**
	 * Original signature : <code>void set_tty_color_mode(tty_display_info*, frame*)</code><br>
	 * <i>native declaration : dispextern.h:2022</i>
	 */
	public static native void set_tty_color_mode(Pointer<FrameLibrary.tty_display_info > tty_display_infoPtr1, Pointer<frame > framePtr1);
	/**
	 * Original signature : <code>terminal* get_named_tty(const char*)</code><br>
	 * <i>native declaration : dispextern.h:2024</i>
	 */
	public static native Pointer<FrameLibrary.terminal > get_named_tty(Pointer<Byte > charPtr1);
	/**
	 ...
	 */
	public static native Pointer<FrameLibrary.terminal > init_tty(Pointer<Byte > charPtr1, Pointer<Byte > charPtr2, int int1);
	/**
	 ...
	 */
	public static native void set_menu_bar_lines(Pointer<frame > framePtr1, FrameLibrary.Lisp_Object Lisp_Object1, FrameLibrary.Lisp_Object Lisp_Object2);
	/**
	 ...
	 */
	public static native FrameLibrary.Lisp_Object delete_frame(FrameLibrary.Lisp_Object Lisp_Object1, FrameLibrary.Lisp_Object Lisp_Object2);
	public int fonts_changed_p() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("fonts_changed_p").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary fonts_changed_p(int fonts_changed_p) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("fonts_changed_p").as(int.class).set(fonts_changed_p);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public glyph space_glyph() {
		try {
			return (glyph)BridJ.getNativeLibrary("frame").getSymbolPointer("space_glyph").as(glyph.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern glyph
	public FrameLibrary space_glyph(glyph space_glyph) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("space_glyph").as(glyph.class).set(space_glyph);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<FrameLibrary.window > updated_window() {
		try {
			return (Pointer<FrameLibrary.window >)BridJ.getNativeLibrary("frame").getSymbolPointer("updated_window").as(DefaultParameterizedType.paramType(Pointer.class, FrameLibrary.window.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern window*
	public FrameLibrary updated_window(Pointer<FrameLibrary.window > updated_window) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("updated_window").as(DefaultParameterizedType.paramType(Pointer.class, FrameLibrary.window.class)).set(updated_window);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<glyph_row > updated_row() {
		try {
			return (Pointer<glyph_row >)BridJ.getNativeLibrary("frame").getSymbolPointer("updated_row").as(DefaultParameterizedType.paramType(Pointer.class, glyph_row.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern glyph_row*
	public FrameLibrary updated_row(Pointer<glyph_row > updated_row) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("updated_row").as(DefaultParameterizedType.paramType(Pointer.class, glyph_row.class)).set(updated_row);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int updated_area() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("updated_area").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary updated_area(int updated_area) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("updated_area").as(int.class).set(updated_area);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int display_completed() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("display_completed").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary display_completed(int display_completed) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("display_completed").as(int.class).set(display_completed);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int face_change_count() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("face_change_count").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary face_change_count(int face_change_count) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("face_change_count").as(int.class).set(face_change_count);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int redisplaying_p() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("redisplaying_p").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary redisplaying_p(int redisplaying_p) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("redisplaying_p").as(int.class).set(redisplaying_p);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int help_echo_showing_p() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("help_echo_showing_p").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary help_echo_showing_p(int help_echo_showing_p) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("help_echo_showing_p").as(int.class).set(help_echo_showing_p);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int current_mode_line_height() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("current_mode_line_height").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary current_mode_line_height(int current_mode_line_height) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("current_mode_line_height").as(int.class).set(current_mode_line_height);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int current_header_line_height() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("current_header_line_height").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary current_header_line_height(int current_header_line_height) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("current_header_line_height").as(int.class).set(current_header_line_height);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<frame > last_mouse_frame() {
		try {
			return (Pointer<frame >)BridJ.getNativeLibrary("frame").getSymbolPointer("last_mouse_frame").as(DefaultParameterizedType.paramType(Pointer.class, frame.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern frame*
	public FrameLibrary last_mouse_frame(Pointer<frame > last_mouse_frame) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("last_mouse_frame").as(DefaultParameterizedType.paramType(Pointer.class, frame.class)).set(last_mouse_frame);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int last_tool_bar_item() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("last_tool_bar_item").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public FrameLibrary last_tool_bar_item(int last_tool_bar_item) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("last_tool_bar_item").as(int.class).set(last_tool_bar_item);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<Byte > unspecified_fg() {
		try {
			return (Pointer<Byte >)BridJ.getNativeLibrary("frame").getSymbolPointer("unspecified_fg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern char[]
	public FrameLibrary unspecified_fg(Pointer<Byte > unspecified_fg) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("unspecified_fg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).set(unspecified_fg);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<Byte > unspecified_bg() {
		try {
			return (Pointer<Byte >)BridJ.getNativeLibrary("frame").getSymbolPointer("unspecified_bg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern char[]
	public FrameLibrary unspecified_bg(Pointer<Byte > unspecified_bg) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("unspecified_bg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).set(unspecified_bg);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int frame_garbaged() {
		try {
			return (int)BridJ.getNativeLibrary("frame").getSymbolPointer("frame_garbaged").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// Nonzero means there is at least one garbaged frame.
	public FrameLibrary frame_garbaged(int frame_garbaged) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("frame_garbaged").as(int.class).set(frame_garbaged);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<frame > last_nonminibuf_frame() {
		try {
			return (Pointer<frame >)BridJ.getNativeLibrary("frame").getSymbolPointer("last_nonminibuf_frame").as(DefaultParameterizedType.paramType(Pointer.class, frame.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern frame*
	public FrameLibrary last_nonminibuf_frame(Pointer<frame > last_nonminibuf_frame) {
		try {
			{
				BridJ.getNativeLibrary("frame").getSymbolPointer("last_nonminibuf_frame").as(DefaultParameterizedType.paramType(Pointer.class, frame.class)).set(last_nonminibuf_frame);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	/// Undefined type
	/// Undefined type
	public static interface font_driver_list {
	...
	/// Undefined type
	/// Undefined type
	public static interface font_data_list {
