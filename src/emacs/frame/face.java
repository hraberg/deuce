...
import emacs.frame.FrameLibrary.face_box_type;
import emacs.frame.FrameLibrary.font;
...
public class face extends StructObject {
	 ...
	 */
	@Array({(int)emacs.frame.FrameLibrary.lface_attribute_index.LFACE_VECTOR_SIZE.value()}) 
	@Field(32) 
