...
/**
 * Wrapper for library <b>window</b><br>
...
public class WindowLibrary {
	...
	/// <i>native declaration : window.h</i>
	public static final int MIN_SAFE_WINDOW_HEIGHT = (int)(1);
	/// <i>native declaration : dispextern.h</i>
	...
	/// <i>native declaration : window.h</i>
	public static final int MIN_SAFE_WINDOW_WIDTH = (int)(2);
	/// <i>native declaration : dispextern.h</i>
	...
	/// <i>native declaration : window.h:1600</i>
	/// <i>native declaration : window.h:1600</i>
	public static abstract class frame_parm_handler extends Callback<frame_parm_handler > {
		public abstract void apply(Pointer<WindowLibrary.frame > framePtr1, WindowLibrary.Lisp_Object Lisp_Object1);
	};
	/**
	 ...
	 */
	public static native void bidi_paragraph_init(IntValuedEnum<WindowLibrary.bidi_dir_t > bidi_dir_t1, Pointer<bidi_it > bidi_itPtr1, int int1);
	/**
	 ...
	 */
	public static native Pointer<glyph_row > row_containing_pos(Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, Pointer<glyph_row > glyph_rowPtr2, int int1);
	/**
	 ...
	 */
	public static native int display_prop_intangible_p(WindowLibrary.Lisp_Object Lisp_Object1, WindowLibrary.Lisp_Object Lisp_Object2);
	/**
	 ...
	 */
	public static native void pixel_to_glyph_coords(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<Integer > intPtr3, int int3);
	/**
	 * Original signature : <code>void remember_mouse_glyph(frame*, int, int, int*)</code><br>
	 * <i>native declaration : dispextern.h:1781</i>
	 */
	public static native void remember_mouse_glyph(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2, Pointer<Integer > intPtr1);
	/**
	 ...
	 */
	public static native void mark_window_display_accurate(WindowLibrary.Lisp_Object Lisp_Object1, int int1);
	/**
	 ...
	 */
	public static native void init_iterator(Pointer<it > itPtr1, Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, IntValuedEnum<WindowLibrary.face_id > arg1);
	/**
	 ...
	 */
	public static native void init_iterator_to_row_start(Pointer<it > itPtr1, Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1);
	/**
	 * Original signature : <code>void start_display(it*, window*, text_pos)</code><br>
	 * <i>native declaration : dispextern.h:1791</i>
	 */
	public static native void start_display(Pointer<it > itPtr1, Pointer<window > windowPtr1, text_pos text_pos1);
	/**
	 ...
	 */
	public static native void move_it_in_display_line(Pointer<it > it, WindowLibrary.EMACS_INT to_charpos, int to_x, IntValuedEnum<WindowLibrary.move_operation_enum > op);
	/**
	 ...
	 */
	public static native int frame_mode_line_height(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 ...
	 */
	public static native WindowLibrary.Lisp_Object lookup_glyphless_char_display(int int1, Pointer<it > itPtr1);
	/**
	 ...
	 */
	public static native WindowLibrary.EMACS_INT compute_display_string_pos(Pointer<text_pos > text_posPtr1, Pointer<bidi_string_data > bidi_string_dataPtr1, int int1, Pointer<Integer > intPtr1);
	/**
	 ...
	 */
	public static native WindowLibrary.EMACS_INT compute_display_string_end(WindowLibrary.EMACS_INT EMACS_INT1, Pointer<bidi_string_data > bidi_string_dataPtr1);
	/**
	 ...
	 */
	public static native void tty_draw_row_with_mouse_face(Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, int int1, int int2, IntValuedEnum<WindowLibrary.draw_glyphs_face > arg1);
	/**
	 * Original signature : <code>int lookup_fringe_bitmap(Lisp_Object)</code><br>
	 * <i>native declaration : dispextern.h:1843</i>
	 */
	public static native int lookup_fringe_bitmap(WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void draw_fringe_bitmap(window*, glyph_row*, int)</code><br>
	 * <i>native declaration : dispextern.h:1845</i>
	 */
	public static native void draw_fringe_bitmap(Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, int int1);
	/**
	 * Original signature : <code>void draw_row_fringe_bitmaps(window*, glyph_row*)</code><br>
	 * <i>native declaration : dispextern.h:1847</i>
	 */
	public static native void draw_row_fringe_bitmaps(Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1);
	/**
	 * Original signature : <code>int draw_window_fringes(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1849</i>
	 */
	public static native int draw_window_fringes(Pointer<window > windowPtr1, int int1);
	/**
	 * Original signature : <code>int update_window_fringes(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1851</i>
	 */
	public static native int update_window_fringes(Pointer<window > windowPtr1, int int1);
	/**
	 * Original signature : <code>void compute_fringe_widths(frame*, int)</code><br>
	 * <i>native declaration : dispextern.h:1853</i>
	 */
	public static native void compute_fringe_widths(Pointer<WindowLibrary.frame > framePtr1, int int1);
	/**
	 ...
	 */
	public static native void update_face_from_frame_parameter(Pointer<WindowLibrary.frame > framePtr1, WindowLibrary.Lisp_Object Lisp_Object1, WindowLibrary.Lisp_Object Lisp_Object2);
	/**
	 * Original signature : <code>Lisp_Object tty_color_name(frame*, int)</code><br>
	 * <i>native declaration : dispextern.h:1871</i>
	 */
	public static native WindowLibrary.Lisp_Object tty_color_name(Pointer<WindowLibrary.frame > framePtr1, int int1);
	/**
	 ...
	 */
	@CLong 
	public static native long load_color(Pointer<WindowLibrary.frame > framePtr1, Pointer<face > facePtr1, WindowLibrary.Lisp_Object Lisp_Object1, IntValuedEnum<WindowLibrary.lface_attribute_index > arg1);
	/**
	 * Original signature : <code>void unload_color(frame*, unsigned long)</code><br>
	 * <i>native declaration : dispextern.h:1877</i>
	 */
	public static native void unload_color(Pointer<WindowLibrary.frame > framePtr1, @CLong long u1);
	/**
	 ...
	 */
	public static native Pointer<Byte > choose_face_font(Pointer<WindowLibrary.frame > framePtr1, Pointer<WindowLibrary.Lisp_Object > Lisp_ObjectPtr1, WindowLibrary.Lisp_Object Lisp_Object1, Pointer<Integer > intPtr1);
	/**
	 * Original signature : <code>void prepare_face_for_display(frame*, face*)</code><br>
	 * <i>native declaration : dispextern.h:1881</i>
	 */
	public static native void prepare_face_for_display(Pointer<WindowLibrary.frame > framePtr1, Pointer<face > facePtr1);
	/**
	 ...
	 */
	public static native int lookup_named_face(Pointer<WindowLibrary.frame > framePtr1, WindowLibrary.Lisp_Object Lisp_Object1, int int1);
	/**
	 * Original signature : <code>int lookup_basic_face(frame*, int)</code><br>
	 * <i>native declaration : dispextern.h:1887</i>
	 */
	public static native int lookup_basic_face(Pointer<WindowLibrary.frame > framePtr1, int int1);
	/**
	 * Original signature : <code>int smaller_face(frame*, int, int)</code><br>
	 * <i>native declaration : dispextern.h:1889</i>
	 */
	public static native int smaller_face(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2);
	/**
	 * Original signature : <code>int face_with_height(frame*, int, int)</code><br>
	 * <i>native declaration : dispextern.h:1891</i>
	 */
	public static native int face_with_height(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2);
	/**
	 ...
	 */
	public static native int lookup_derived_face(Pointer<WindowLibrary.frame > framePtr1, WindowLibrary.Lisp_Object Lisp_Object1, int int1, int int2);
	/**
	 * Original signature : <code>void init_frame_faces(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1895</i>
	 */
	public static native void init_frame_faces(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>void free_frame_faces(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1897</i>
	 */
	public static native void free_frame_faces(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>void recompute_basic_faces(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1899</i>
	 */
	public static native void recompute_basic_faces(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 ...
	 */
	public static native int face_at_buffer_position(Pointer<window > w, WindowLibrary.EMACS_INT pos, WindowLibrary.EMACS_INT region_beg, WindowLibrary.EMACS_INT region_end, Pointer<WindowLibrary.EMACS_INT > endptr, WindowLibrary.EMACS_INT limit, int mouse, int base_face_id);
	/**
	 ...
	 */
	public static native int face_for_overlay_string(Pointer<window > w, WindowLibrary.EMACS_INT pos, WindowLibrary.EMACS_INT region_beg, WindowLibrary.EMACS_INT region_end, Pointer<WindowLibrary.EMACS_INT > endptr, WindowLibrary.EMACS_INT limit, int mouse, WindowLibrary.Lisp_Object overlay);
	/**
	 ...
	 */
	public static native int face_at_string_position(Pointer<window > w, WindowLibrary.Lisp_Object string, WindowLibrary.EMACS_INT pos, WindowLibrary.EMACS_INT bufpos, WindowLibrary.EMACS_INT region_beg, WindowLibrary.EMACS_INT region_end, Pointer<WindowLibrary.EMACS_INT > endptr, IntValuedEnum<WindowLibrary.face_id > arg1, int mouse);
	/**
	 * Original signature : <code>int merge_faces(frame*, Lisp_Object, EMACS_INT, int)</code><br>
	 * <i>native declaration : dispextern.h:1907</i>
	 */
	public static native int merge_faces(Pointer<WindowLibrary.frame > framePtr1, WindowLibrary.Lisp_Object Lisp_Object1, WindowLibrary.EMACS_INT EMACS_INT1, int int1);
	/**
	 * Original signature : <code>int compute_char_face(frame*, int, Lisp_Object)</code><br>
	 * <i>native declaration : dispextern.h:1909</i>
	 */
	public static native int compute_char_face(Pointer<WindowLibrary.frame > framePtr1, int int1, WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void free_all_realized_faces(Lisp_Object)</code><br>
	 * <i>native declaration : dispextern.h:1911</i>
	 */
	public static native void free_all_realized_faces(WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 ...
	 */
	public static native WindowLibrary.Lisp_Object buffer_posn_from_coords(Pointer<window > windowPtr1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<display_pos > display_posPtr1, Pointer<WindowLibrary.Lisp_Object > Lisp_ObjectPtr1, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, Pointer<Integer > intPtr5, Pointer<Integer > intPtr6);
	/**
	 ...
	 */
	public static native WindowLibrary.Lisp_Object mode_line_string(Pointer<window > windowPtr1, IntValuedEnum<WindowLibrary.window_part > arg1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<WindowLibrary.EMACS_INT > EMACS_INTPtr1, Pointer<WindowLibrary.Lisp_Object > Lisp_ObjectPtr1, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, Pointer<Integer > intPtr5, Pointer<Integer > intPtr6);
	/**
	 ...
	 */
	public static native WindowLibrary.Lisp_Object marginal_area_string(Pointer<window > windowPtr1, IntValuedEnum<WindowLibrary.window_part > arg1, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<WindowLibrary.EMACS_INT > EMACS_INTPtr1, Pointer<WindowLibrary.Lisp_Object > Lisp_ObjectPtr1, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, Pointer<Integer > intPtr5, Pointer<Integer > intPtr6);
	/**
	 * Original signature : <code>void redraw_frame(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1925</i>
	 */
	public static native void redraw_frame(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>void cancel_line(int, frame*)</code><br>
	 * <i>native declaration : dispextern.h:1927</i>
	 */
	public static native void cancel_line(int int1, Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>void init_desired_glyphs(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1929</i>
	 */
	public static native void init_desired_glyphs(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>int update_frame(frame*, int, int)</code><br>
	 * <i>native declaration : dispextern.h:1931</i>
	 */
	public static native int update_frame(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2);
	/**
	 ...
	 */
	public static native void adjust_glyphs(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>void free_glyphs(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1937</i>
	 */
	public static native void free_glyphs(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>void free_window_matrices(window*)</code><br>
	 * <i>native declaration : dispextern.h:1939</i>
	 */
	public static native void free_window_matrices(Pointer<window > windowPtr1);
	/**
	 ...
	 */
	public static native void clear_current_matrices(Pointer<WindowLibrary.frame > f);
	/**
	 * Original signature : <code>void clear_desired_matrices(frame*)</code><br>
	 * <i>native declaration : dispextern.h:1949</i>
	 */
	public static native void clear_desired_matrices(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 ...
	 */
	public static native void shift_glyph_matrix(Pointer<window > windowPtr1, Pointer<glyph_matrix > glyph_matrixPtr1, int int1, int int2, int int3);
	/**
	 ...
	 */
	public static native void increment_matrix_positions(Pointer<glyph_matrix > glyph_matrixPtr1, int int1, int int2, WindowLibrary.EMACS_INT EMACS_INT1, WindowLibrary.EMACS_INT EMACS_INT2);
	/**
	 * Original signature : <code>void blank_row(window*, glyph_row*, int)</code><br>
	 * <i>native declaration : dispextern.h:1957</i>
	 */
	public static native void blank_row(Pointer<window > windowPtr1, Pointer<glyph_row > glyph_rowPtr1, int int1);
	/**
	 ...
	 */
	public static native void set_window_update_flags(Pointer<window > windowPtr1, int int1);
	/**
	 * Original signature : <code>void update_single_window(window*, int)</code><br>
	 * <i>native declaration : dispextern.h:1967</i>
	 */
	public static native void update_single_window(Pointer<window > windowPtr1, int int1);
	/**
	 ...
	 */
	public static native void change_frame_size(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2, int int3, int int4, int int5);
	/**
	 ...
	 */
	public static native void calculate_costs(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 ...
	 */
	public static native void produce_special_glyphs(Pointer<it > itPtr1, IntValuedEnum<WindowLibrary.display_element_type > arg1);
	/**
	 ...
	 */
	public static native int tty_capable_p(Pointer<WindowLibrary.tty_display_info > tty_display_infoPtr1, int u1, @CLong long u2, @CLong long u3);
	/**
	 * Original signature : <code>void set_tty_color_mode(tty_display_info*, frame*)</code><br>
	 * <i>native declaration : dispextern.h:2022</i>
	 */
	public static native void set_tty_color_mode(Pointer<WindowLibrary.tty_display_info > tty_display_infoPtr1, Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>terminal* get_named_tty(const char*)</code><br>
	 * <i>native declaration : dispextern.h:2024</i>
	 */
	public static native Pointer<WindowLibrary.terminal > get_named_tty(Pointer<Byte > charPtr1);
	/**
	 * Original signature : <code>void create_tty_output(frame*)</code><br>
	 * <i>native declaration : dispextern.h:2026</i>
	 */
	public static native void create_tty_output(Pointer<WindowLibrary.frame > framePtr1);
	/**
	 * Original signature : <code>terminal* init_tty(const char*, const char*, int)</code><br>
	 * <i>native declaration : dispextern.h:2028</i>
	 */
	public static native Pointer<WindowLibrary.terminal > init_tty(Pointer<Byte > charPtr1, Pointer<Byte > charPtr2, int int1);
	/**
	 ...
	 */
	public static native void do_line_insertion_deletion_costs(Pointer<WindowLibrary.frame > framePtr1, Pointer<Byte > charPtr1, Pointer<Byte > charPtr2, Pointer<Byte > charPtr3, Pointer<Byte > charPtr4, Pointer<Byte > charPtr5, Pointer<Byte > charPtr6, int int1);
	/**
	 ...
	 */
	public static native void scrolling_1(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2, int int3, Pointer<Integer > intPtr1, Pointer<Integer > intPtr2, Pointer<Integer > intPtr3, Pointer<Integer > intPtr4, int int4);
	/**
	 * Original signature : <code>Lisp_Object make_window()</code><br>
	 * <i>native declaration : window.h:2361</i>
	 */
	public static native WindowLibrary.Lisp_Object make_window();
	/**
	 * Original signature : <code>Lisp_Object window_from_coordinates(frame*, int, int, window_part*, int)</code><br>
	 * <i>native declaration : window.h:2363</i>
	 */
	public static native WindowLibrary.Lisp_Object window_from_coordinates(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2, Pointer<IntValuedEnum<WindowLibrary.window_part > > arg1, int int3);
	/**
	 * Original signature : <code>void resize_frame_windows(frame*, int, int)</code><br>
	 * <i>native declaration : window.h:2365</i>
	 */
	public static native void resize_frame_windows(Pointer<WindowLibrary.frame > framePtr1, int int1, int int2);
	/**
	 * Original signature : <code>void delete_all_child_windows(Lisp_Object)</code><br>
	 * <i>native declaration : window.h:2367</i>
	 */
	public static native void delete_all_child_windows(WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void freeze_window_starts(frame*, int)</code><br>
	 * <i>native declaration : window.h:2369</i>
	 */
	public static native void freeze_window_starts(Pointer<WindowLibrary.frame > framePtr1, int int1);
	/**
	 * Original signature : <code>void grow_mini_window(window*, int)</code><br>
	 * <i>native declaration : window.h:2371</i>
	 */
	public static native void grow_mini_window(Pointer<window > windowPtr1, int int1);
	/**
	 * Original signature : <code>void shrink_mini_window(window*)</code><br>
	 * <i>native declaration : window.h:2373</i>
	 */
	public static native void shrink_mini_window(Pointer<window > windowPtr1);
	/**
	 * Original signature : <code>int window_relative_x_coord(window*, window_part, int)</code><br>
	 * <i>native declaration : window.h:2375</i>
	 */
	public static native int window_relative_x_coord(Pointer<window > windowPtr1, IntValuedEnum<WindowLibrary.window_part > arg1, int int1);
	/**
	 * Original signature : <code>void run_window_configuration_change_hook(frame*)</code><br>
	 * <i>native declaration : window.h:2377</i>
	 */
	public static native void run_window_configuration_change_hook(Pointer<WindowLibrary.frame > f);
	/**
	 * Original signature : <code>void set_window_buffer(Lisp_Object, Lisp_Object, int, int)</code><br>
	 * <i>native declaration : window.h:2379</i>
	 */
	public static native void set_window_buffer(WindowLibrary.Lisp_Object window, WindowLibrary.Lisp_Object buffer, int run_hooks_p, int keep_margins_p);
	/**
	 * Original signature : <code>void check_frame_size(frame*, int*, int*)</code><br>
	 * <i>native declaration : window.h:2389</i>
	 */
	public static native void check_frame_size(Pointer<WindowLibrary.frame > frame, Pointer<Integer > rows, Pointer<Integer > cols);
	/**
	 * Original signature : <code>glyph* get_phys_cursor_glyph(window*)</code><br>
	 * <i>native declaration : window.h:2391</i>
	 */
	public static native Pointer<glyph > get_phys_cursor_glyph(Pointer<window > w);
	/**
	 * Original signature : <code>int compare_window_configurations(Lisp_Object, Lisp_Object, int)</code><br>
	 * <i>native declaration : window.h:2396</i>
	 */
	public static native int compare_window_configurations(WindowLibrary.Lisp_Object Lisp_Object1, WindowLibrary.Lisp_Object Lisp_Object2, int int1);
	/**
	 * Original signature : <code>void mark_window_cursors_off(window*)</code><br>
	 * <i>native declaration : window.h:2398</i>
	 */
	public static native void mark_window_cursors_off(Pointer<window > windowPtr1);
	/**
	 * Original signature : <code>int window_internal_height(window*)</code><br>
	 * <i>native declaration : window.h:2400</i>
	 */
	public static native int window_internal_height(Pointer<window > windowPtr1);
	/**
	 * Original signature : <code>int window_body_cols(window*)</code><br>
	 * <i>native declaration : window.h:2402</i>
	 */
	public static native int window_body_cols(Pointer<window > w);
	/**
	 * Original signature : <code>void temp_output_buffer_show(Lisp_Object)</code><br>
	 * <i>native declaration : window.h:2404</i>
	 */
	public static native void temp_output_buffer_show(WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void replace_buffer_in_windows(Lisp_Object)</code><br>
	 * <i>native declaration : window.h:2406</i>
	 */
	public static native void replace_buffer_in_windows(WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void replace_buffer_in_windows_safely(Lisp_Object)</code><br>
	 * <i>native declaration : window.h:2408</i>
	 */
	public static native void replace_buffer_in_windows_safely(WindowLibrary.Lisp_Object Lisp_Object1);
	/**
	 * Original signature : <code>void init_window_once()</code><br>
	 * <i>native declaration : window.h:2410</i>
	 */
	public static native void init_window_once();
	/**
	 * Original signature : <code>void init_window()</code><br>
	 * <i>native declaration : window.h:2412</i>
	 */
	public static native void init_window();
	/**
	 * Original signature : <code>void syms_of_window()</code><br>
	 * <i>native declaration : window.h:2414</i>
	 */
	public static native void syms_of_window();
	/**
	 * Original signature : <code>void keys_of_window()</code><br>
	 * <i>native declaration : window.h:2416</i>
	 */
	public static native void keys_of_window();
	public int fonts_changed_p() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("fonts_changed_p").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary fonts_changed_p(int fonts_changed_p) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("fonts_changed_p").as(int.class).set(fonts_changed_p);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public glyph space_glyph() {
		try {
			return (glyph)BridJ.getNativeLibrary("window").getSymbolPointer("space_glyph").as(glyph.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern glyph
	public WindowLibrary space_glyph(glyph space_glyph) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("space_glyph").as(glyph.class).set(space_glyph);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<window > updated_window() {
		try {
			return (Pointer<window >)BridJ.getNativeLibrary("window").getSymbolPointer("updated_window").as(DefaultParameterizedType.paramType(Pointer.class, window.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern window*
	public WindowLibrary updated_window(Pointer<window > updated_window) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("updated_window").as(DefaultParameterizedType.paramType(Pointer.class, window.class)).set(updated_window);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<glyph_row > updated_row() {
		try {
			return (Pointer<glyph_row >)BridJ.getNativeLibrary("window").getSymbolPointer("updated_row").as(DefaultParameterizedType.paramType(Pointer.class, glyph_row.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern glyph_row*
	public WindowLibrary updated_row(Pointer<glyph_row > updated_row) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("updated_row").as(DefaultParameterizedType.paramType(Pointer.class, glyph_row.class)).set(updated_row);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int updated_area() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("updated_area").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary updated_area(int updated_area) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("updated_area").as(int.class).set(updated_area);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int display_completed() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("display_completed").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary display_completed(int display_completed) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("display_completed").as(int.class).set(display_completed);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int face_change_count() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("face_change_count").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary face_change_count(int face_change_count) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("face_change_count").as(int.class).set(face_change_count);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int redisplaying_p() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("redisplaying_p").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary redisplaying_p(int redisplaying_p) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("redisplaying_p").as(int.class).set(redisplaying_p);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int help_echo_showing_p() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("help_echo_showing_p").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary help_echo_showing_p(int help_echo_showing_p) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("help_echo_showing_p").as(int.class).set(help_echo_showing_p);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int current_mode_line_height() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("current_mode_line_height").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary current_mode_line_height(int current_mode_line_height) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("current_mode_line_height").as(int.class).set(current_mode_line_height);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int current_header_line_height() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("current_header_line_height").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary current_header_line_height(int current_header_line_height) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("current_header_line_height").as(int.class).set(current_header_line_height);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	/// C type : extern frame*
	public Pointer<WindowLibrary.frame > last_mouse_frame() {
		try {
			return (Pointer<WindowLibrary.frame >)BridJ.getNativeLibrary("window").getSymbolPointer("last_mouse_frame").as(DefaultParameterizedType.paramType(Pointer.class, WindowLibrary.frame.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern frame*
	public WindowLibrary last_mouse_frame(Pointer<WindowLibrary.frame > last_mouse_frame) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("last_mouse_frame").as(DefaultParameterizedType.paramType(Pointer.class, WindowLibrary.frame.class)).set(last_mouse_frame);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int last_tool_bar_item() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("last_tool_bar_item").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary last_tool_bar_item(int last_tool_bar_item) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("last_tool_bar_item").as(int.class).set(last_tool_bar_item);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<Byte > unspecified_fg() {
		try {
			return (Pointer<Byte >)BridJ.getNativeLibrary("window").getSymbolPointer("unspecified_fg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern char[]
	public WindowLibrary unspecified_fg(Pointer<Byte > unspecified_fg) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("unspecified_fg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).set(unspecified_fg);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public Pointer<Byte > unspecified_bg() {
		try {
			return (Pointer<Byte >)BridJ.getNativeLibrary("window").getSymbolPointer("unspecified_bg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	/// C type : extern char[]
	public WindowLibrary unspecified_bg(Pointer<Byte > unspecified_bg) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("unspecified_bg").as(DefaultParameterizedType.paramType(Pointer.class, Byte.class)).set(unspecified_bg);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int window_select_count() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("window_select_count").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary window_select_count(int window_select_count) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("window_select_count").as(int.class).set(window_select_count);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int update_mode_lines() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("update_mode_lines").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary update_mode_lines(int update_mode_lines) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("update_mode_lines").as(int.class).set(update_mode_lines);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int clip_changed() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("clip_changed").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary clip_changed(int clip_changed) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("clip_changed").as(int.class).set(clip_changed);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int windows_or_buffers_changed() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("windows_or_buffers_changed").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary windows_or_buffers_changed(int windows_or_buffers_changed) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("windows_or_buffers_changed").as(int.class).set(windows_or_buffers_changed);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int cursor_type_changed() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("cursor_type_changed").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary cursor_type_changed(int cursor_type_changed) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("cursor_type_changed").as(int.class).set(cursor_type_changed);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
	...
	public int buffer_shared() {
		try {
			return (int)BridJ.getNativeLibrary("window").getSymbolPointer("buffer_shared").as(int.class).get();
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
		}
	}
	public WindowLibrary buffer_shared(int buffer_shared) {
		try {
			{
				BridJ.getNativeLibrary("window").getSymbolPointer("buffer_shared").as(int.class).set(buffer_shared);
				return this;
			}
		}catch (Throwable $ex$) {
			throw new RuntimeException($ex$);
