...
import emacs.window.WindowLibrary.Lisp_Char_Table;
import emacs.window.WindowLibrary.Lisp_Object;
import emacs.window.WindowLibrary.bidi_dir_t;
import emacs.window.WindowLibrary.display_element_type;
import emacs.window.WindowLibrary.frame;
import emacs.window.WindowLibrary.glyph_row_area;
import emacs.window.WindowLibrary.glyphless_display_method;
import emacs.window.WindowLibrary.it_method;
import emacs.window.WindowLibrary.line_wrap_method;
...
public class it extends StructObject {
	...
	public static class iterator_stack_entry extends StructObject {
		 ...
		 */
		@Field(8) 
		public emacs.window.glyph.u_union u() {
		 ...
		 */
		@Field(8) 
		public iterator_stack_entry u(emacs.window.glyph.u_union u) {
		...
		public static class u_union extends StructObject {
			 ...
			 */
			@Field(0) 
			public emacs.window.glyph.u_union.image_struct image() {
			 ...
			 */
			@Field(0) 
			public u_union image(emacs.window.glyph.u_union.image_struct image) {
			 ...
			 */
			@Field(1) 
			public emacs.window.glyph.u_union.comp_struct comp() {
			 ...
			 */
			@Field(1) 
			public u_union comp(emacs.window.glyph.u_union.comp_struct comp) {
			 ...
			 */
			@Field(2) 
			public emacs.window.glyph.u_union.stretch_struct stretch() {
			 ...
			 */
			@Field(2) 
			public u_union stretch(emacs.window.glyph.u_union.stretch_struct stretch) {
