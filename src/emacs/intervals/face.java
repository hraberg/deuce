...
import emacs.intervals.IntervalsLibrary.face_box_type;
import emacs.intervals.IntervalsLibrary.font;
...
public class face extends StructObject {
	 ...
	 */
	@Array({(int)emacs.intervals.IntervalsLibrary.lface_attribute_index.LFACE_VECTOR_SIZE.value()}) 
	@Field(32) 
