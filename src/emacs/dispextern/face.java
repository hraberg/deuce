...
import emacs.dispextern.DispexternLibrary.face_box_type;
import emacs.dispextern.DispexternLibrary.font;
...
public class face extends StructObject {
	 ...
	 */
	@Array({(int)emacs.dispextern.DispexternLibrary.lface_attribute_index.LFACE_VECTOR_SIZE.value()}) 
	@Field(32) 
