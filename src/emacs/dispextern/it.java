...
import emacs.dispextern.DispexternLibrary.Lisp_Char_Table;
import emacs.dispextern.DispexternLibrary.Lisp_Object;
import emacs.dispextern.DispexternLibrary.bidi_dir_t;
import emacs.dispextern.DispexternLibrary.display_element_type;
import emacs.dispextern.DispexternLibrary.frame;
import emacs.dispextern.DispexternLibrary.glyph_row_area;
import emacs.dispextern.DispexternLibrary.glyphless_display_method;
import emacs.dispextern.DispexternLibrary.it_method;
import emacs.dispextern.DispexternLibrary.line_wrap_method;
import emacs.dispextern.DispexternLibrary.window;
...
public class it extends StructObject {
	...
	public static class iterator_stack_entry extends StructObject {
		 ...
		 */
		@Field(8) 
		public emacs.dispextern.glyph.u_union u() {
		 ...
		 */
		@Field(8) 
		public iterator_stack_entry u(emacs.dispextern.glyph.u_union u) {
		...
		public static class u_union extends StructObject {
			 ...
			 */
			@Field(0) 
			public emacs.dispextern.glyph.u_union.image_struct image() {
			 ...
			 */
			@Field(0) 
			public u_union image(emacs.dispextern.glyph.u_union.image_struct image) {
			 ...
			 */
			@Field(1) 
			public emacs.dispextern.glyph.u_union.comp_struct comp() {
			 ...
			 */
			@Field(1) 
			public u_union comp(emacs.dispextern.glyph.u_union.comp_struct comp) {
			 ...
			 */
			@Field(2) 
			public emacs.dispextern.glyph.u_union.stretch_struct stretch() {
			 ...
			 */
			@Field(2) 
			public u_union stretch(emacs.dispextern.glyph.u_union.stretch_struct stretch) {
