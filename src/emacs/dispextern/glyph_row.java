...
public class glyph_row extends StructObject {
	 ...
	 */
	@Array({1 + (int)emacs.dispextern.DispexternLibrary.glyph_row_area.LAST_AREA.value()}) 
	@Field(0) 
	 ...
	 */
	@Array({(int)emacs.dispextern.DispexternLibrary.glyph_row_area.LAST_AREA.value()}) 
	@Field(1) 
